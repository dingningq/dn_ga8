...
UIMIX.fullview = {
    ...
    init: function() {
        ...
        UIMIX.fullview.data.container.on({
            mousedown: function() {
                $(UIMIX.fullview.data.dragEleClass).addClass("drag")
            },
            mouseup: function() {
                $(UIMIX.fullview.data.dragEleClass).removeClass("drag")
            }
        });
        ...
        UIMIX.fullview.loadImage();
        $(UIMIX.fullview.data.dragEleClass).mousedown(function(event) {
